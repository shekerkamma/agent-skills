...
### Lifecycle Position
Step 3 of 13 — Define phase. Runs after idea-refine, before planning-and-task-breakdown.
...
### Runtime Preamble
Writing the spec before any code. Prerequisites: idea-refine or interview-me are helpful but not required. After spec approval, next step is planning-and-task-breakdown.
